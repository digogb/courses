...
<table class="table" id="tCredit">
  ...
  @forelse($billingCycle->credits as $credit)         
    <tr>
       ...
       <td>
           <button formaction="/billingCycles/addCreditRow/{{$tab}}" type="submit" class="btn btn-success"><i class="fa fa-plus"></i></a>
  ...
  @empty  
      <tr>
        <button formaction="/billingCycles/addCreditRow/{{$tab}}" type="submit" class="btn btn-primary">Adicionar Crédito</i></a>
      </tr>  
    @endforelse
      </tbody>  
</table>
